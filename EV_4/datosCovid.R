...
abline(fitnacional.trat, col="black")
legend(8,9,legend = "log(casos) = 0.8802 + 0.6922 log(PCR)",bty="n")
legend(8,8.7,legend = "R-squared: 0.3059",bty="n")
plot(nacional.trat, main="Valparaíso", xlab="log(PCR)", ylab="log(casos)")
abline(fitnacional.trat, col="black")
legend(8,9,legend = "log(casos) = 0.3539 + 0.6504 log(PCR)",bty="n")
legend(8,8.7,legend = "R-squared: 0.4376",bty="n")
plot(nacional.trat, main="Antofagasta", xlab="log(PCR)", ylab="log(casos)")
abline(fitnacional.trat, col="black")
legend(8,9,legend = "log(casos) = 1.7015 + 0.4317 log(PCR)",bty="n")
legend(8,8.7,legend = "R-squared: 0.1903",bty="n")
